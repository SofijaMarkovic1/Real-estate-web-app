            ...
            <div class="row" id="oglasi">
                <div class="row">
                    <div class="col-sm-8" id="slikeIOpis">
                        <div class="carousel slide" data-ride="carousel" id="oglasSlajder">
                            <div class="carousel-inner">
                                <?php
                                $size = sizeof($slike);
                                $kupac = $_SESSION['user']->ime_prezime;
                                echo "<input type=\"hidden\" id=\"brojSlika\" name=\"brojSlika\" value=\"$size\">";
                                echo "<input type=\"hidden\" id=\"imeProdavca\" name=\"imeProdavca\" value=\"$prodavac->ime_prezime\">";
                                echo "<input type=\"hidden\" id=\"mejlProdavca\" name=\"mejlProdavca\" value=\"$prodavac->email\">";
                                echo "<input type=\"hidden\" id=\"imeKupca\" name=\"imeKupca\" value=\"$kupac\">";
                                echo "<input type=\"hidden\" id=\"opis\" name=\"opis\" value=\"$nekretnina->opis\">";
                    ...
                    <div class="col-sm-4" id="info">
                        ...
                        <br><br>
                        <div class="container">
                            <h4>Zakažite termin posete nekretnini:</h4>
                            <br>
                            <div class="form-group">
                                ...
                                <button class="btn btn-outline-dark" id="emailButton" style="margin-bottom: 20px;">Zakaži</button>
                            </div>
                        </div>
