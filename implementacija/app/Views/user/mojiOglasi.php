    ...
    <div class="container-fluid" style="padding-left: 0%; padding-right: 0%;">
                    ...
                    <div class="row">
                        <div id="opstine" class="col-sm-6" style="margin-right: 5px solid rgb(149, 148, 148);">
                            ...
                            foreach ($opstine as $row) {
                                $opstina = $row['opstina'];
                                echo "
                                    <input type=\"checkbox\" class=\"form-check-input\"> $opstina<br>
                                ";
                                $i++;
                            }
                            ?>
                        ...
                        <div id="opremljenostIGrejanje" class="col-sm-6">
                            ...
                            foreach ($opreme as $oprema) {
                                ...
                                echo "
                                    <input type=\"checkbox\" class=\"form-check-input\"> $oprema->naziv<br>
                                ";
                                $i++;
                            }
                            ?>
                            ...
                            foreach ($grejanja as $grejanje) {
                                echo "
                                    <input type=\"checkbox\" class=\"form-check-input\" >$grejanje->naziv<br>
                                ";
                                $i++;
                            }
                            ?>
                    ...
                    <div class="row" id="tip">
                        <div class="col-sm-6">
                            ...
                            foreach ($tipovi as $tip){
                                echo "
                                        <input type=\"checkbox\" class=\"form-check-input\" >$tip->naziv<br>
                                    ";
                                $i++;
                            }
                            ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            foreach ($stanja as $stanje) {
                                echo "
                                    <input type=\"checkbox\" class=\"form-check-input\" > $stanje->naziv<br>
                                ";
                                $i++;
                            }
                            ?>
        ...
        <div class=\"col-sm-3\" style=\"padding-left: 0px; padding-right: 0px;\">
            <div class=\"card\" style=\"width: 100%; height: 400px;\">
                ...
                <div>
                    <img class=\"kanta\" src=\"".base_url("images/trashcan.png")."\" height=\"20px\" width=\"30px\" style=\"margin-left: 83%; margin-top: 5%; margin-bottom: 2%;\" id=\"$nekretnina->idNekretnina\">
                </div>
