    ...
    <div class="container-fluid" style="padding-left: 0%; padding-right: 0%;">     
        <div class="row" style="overflow: auto;">
            <div class="col-sm-3 filters">
                ...
                <form method="POST" action="/Guest/pretragaGost">
            ...
            <div class="col-sm-9">
                ...
                <?php //echo form_open("Guest/pretragaPoNazivu"); ?>
        ...
        <div class=\"col-sm-3\" style=\"padding-left: 0px; padding-right: 0px;\">
            <div class=\"card\" style=\"width: 100%; height: 400px;\">
                ...
                <div>
                    <img class=\"srceGost\" src=\"".base_url("images/srce.png")."\" height=\"30px\" width=\"40px\" style=\"margin-left: 83%; margin-top: 5%; margin-bottom: 2%;\" id=\"$nekretnina->idNekretnina\">
                </div>
                <a href=\"".base_url("Guest/prikazOglasa")."/".$nekretnina->idNekretnina."\">
