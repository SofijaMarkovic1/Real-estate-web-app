...
class LoginTest extends DbTestCase
{
    ...
    public function test_change_to_old_username(){
        ...
        $_REQUEST["korime"] = "lukal";
        $result = $this->controller('\App\Controllers\Login')->execute('izmeniPodatkePotvrda'); 
    ...
    public function test_delete_ad(){
        ...
        $result = $this->controller('\App\Controllers\Login')->execute('obrisiNekretninu'); 
    ...
    public function test_view_my_ads_when_no_ads(){
        ...
        $result = $this->controller('\App\Controllers\Login')->execute('mojiOglasi'); 
    ...
    public function test_add_to_favourites(){
        ...
        $result = $this->controller('\App\Controllers\Login')->execute('dodajFavorit'); 
    ...
    public function test_delete_from_favourites(){
        ...
        $result = $this->controller('\App\Controllers\Login')->execute('ukloniFavorit'); 
